...
internal class Program
{
    ...
    {
        Console.Write(new Rule($"[underline silver]Starting distributed counter consumer...[/]")
        ...
        {
            WorkerThread wt = new WorkerThread(pc, dcos, MessageCallback);
            wt.StartThread();
        }

        Console.Write(new Rule($"[underline silver]{numWorkerThreads}[/] worker threads are running...")
            { Justification = Justify.Left });
